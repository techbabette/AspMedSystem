...
{
    public class EfUserTreatmentSearchPrescriberQuery : EfUseCase, IUserTreatmentSearchPrescriberQuery
    {
        private readonly IApplicationActor actor;

        private EfUserTreatmentSearchPrescriberQuery()
        {
        }

        public EfUserTreatmentSearchPrescriberQuery(MedSystemContext context, IApplicationActor actor) : base(context)
        {
            this.actor = actor;
        }

        public string Name => "Search prescriptions as prescriber";
        ...
        public PagedResponse<UserTreatmentSearchResultDTO> Execute(UserTreatmentSearchDTO search)
        {
            ...
            query = query.Where(ut => ut.Report.Examination.ExaminationTerm.ExaminerId == actor.Id);
